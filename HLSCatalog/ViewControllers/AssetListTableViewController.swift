...
class AssetListTableViewController: UITableViewController {
    // MARK: Properties
    fileprivate var assetsListViewModel: AssetsListViewModel!
    ...
    override func viewDidLoad() {
        ...
        assetsListViewModel.delegate = self
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return self.assetsListViewModel.numberOfAssets()
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let asset = assetsListViewModel.asset(at: indexPath.row)
...
extension AssetListTableViewController: AssetsListViewModelDelegate {
...
extension AssetListTableViewController: AssetPlaybackDelegate {
    func streamPlaybackManager(_ streamPlaybackManager: AssetPlaybackManager, player: AVPlayer, didPlayToTime time: CMTime) {
        ...
        print("reporting progress for: \(Int(round(time.seconds))) seconds")
    }
